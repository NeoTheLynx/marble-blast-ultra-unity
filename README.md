...
The unity port of the classic game Marble Blast Ultra, with the most accurate physics (although not identical). This project started from CyberFox's [MarblePhysics Unity](https://github.com/CyberFoxHax/MarblePhysicsUnity) that already has a faithful marble movement physics, then continued with codes based on [Marble Blast Web Port](https://github.com/Vanilagy/MarbleBlast) and [Marble Blast Haxe Port](https://github.com/RandomityGuy/MBHaxe/). The Unity version used is Unity 2022.3.62f3. Note that this version of the Narble Blast Ultra Unity Port does not implement Traplaunches.
...
If you find bugs or things that are not faithful with the original Marble Blast Ultra, feel free to message me on discord NaCl586#8479.
